...
function Map() {
  ...
  $.ajax({
    ...
    data: {
      key: "977448115778e91feca7fe7a7e530ba4",
      lon: longitude,
      lat: latitude,
  ...
  useEffect(() => {
    if (UserLocation != "unknown") {
      ...
      firebaseApp.auth().onAuthStateChanged(user => {
        ...
        var road2 = res[0] + ' ' + road_number_minus1

        const db = firebaseApp.firestore()
        const RestaurantCollection = db.collection('Restaurant').where('road', 'in', [road, road1, road2])
              ...
              <CardBody>
                ...
                <Row>
                  <Col md="12">
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;<img
                      alt="..."
                      src="https://res.cloudinary.com/daxwfdlwj/image/upload/v1620030895/Food/location_el422m.png"
                      className="photo1"
